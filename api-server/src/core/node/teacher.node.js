...
//         process.on('SIGINT', async () => {
//             console.log('\n[ApiServer] Received SIGINT signal');
//             process.exit(0);
//         });

//         process.on('exit', (code) => {
//             console.log(`\n[ApiServer] Process exit with code: ${code}`);
//         });
//     }

//     async onStart() {
//         console.log('API Server is starting...');
//         // 这里可以删除与用户相关的逻辑，因为API服务器不需要用户信息
//     }
...
//             const response = await axios.post(`${apiServerUrl}/server/map`, requestData);
//             console.log('Mapping request response:', response.data);
//         } catch (error) {
//             console.error('Failed to send mapping request:', error);
//         }
...
//         try {
//             console.log('[ApiServer] Starting new API server...');
...
//             await server.start();
//             console.log('[ApiServer] API server started successfully');
            
//             return server;
//         } catch (error) {
//             console.error('[ApiServer] Failed to start server:', error.message);
//             throw error;
//         }
//     }
// }
